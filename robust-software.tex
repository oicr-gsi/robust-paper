...
and to use it simply to synchronize files between multiple developers and machines.
...
We also recommend that you \ruleminor{tag your releases}.
A ``tag'' is a label that marks a particular revision in a repository's history.
Adding such labels makes it much easier to find desired revisions at a later date,
and also makes it clear exactly what was released.
