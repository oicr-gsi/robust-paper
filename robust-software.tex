...
Not all software needs to be robust enough to run for other people,
but software that is published and distributed to the community should be.
...
or something equally obvious is a 
good solution that lets new users build their analysis from a working script.
