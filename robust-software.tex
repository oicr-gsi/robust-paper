...
\item
Mention that these rules are necessary but not sufficient for software that needs to interact with services
such as database and web servers.
Such software is often stopped and started under automatic control,
may need to authenticate,
etc.,
all of which are out of scope of this paper.

\item
Mention that reusing software introduces dependencies,
which can bring its own special pain.
